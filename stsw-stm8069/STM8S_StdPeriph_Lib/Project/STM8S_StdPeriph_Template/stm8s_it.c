...
#include "stm8s_eval.h"//add by dr.ye
...
/**
  ...
  * @retval None
  */
bool Door_DetcFlag=FALSE;
bool PeoInductionFlag=FALSE;
bool ANTIRemoveFlag=FALSE;

bool Door_DetcSendAgainFlag=FALSE;
bool PeoInductionSendAgainFlag=FALSE;
bool ANTIRemoveSendAgainFlag=FALSE;
...
/**
 ...
 {
   RECinsert((QUEUE_TYPE)UART3_ReceiveData8());
   //UART3_SendData8(0X0D);
   //UART3_SendData8(0X0A);
